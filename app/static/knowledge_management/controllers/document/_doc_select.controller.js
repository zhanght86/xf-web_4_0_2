...
module.exports = knowledgeManagementModule =>{
    knowledgeManagementModule.controller('DocSelectController', [
    '$scope', '$location', "$stateParams", "$interval", "$timeout", "ngDialog","TemplateService","localStorageService","$state","$sce",
    ($scope, $location, $stateParams, $interval, $timeout, ngDialog, TemplateService,localStorageService,$state,$sce) =>{
        $scope.vm = {
