...
module.exports = knowledgeManagementModule =>{
    knowledgeManagementModule.controller('AnalyseTaskController', [
    '$scope', '$location', "$routeParams", "$interval", "$timeout", "ngDialog", "KnowDocService","TemplateService","TipService","$state",
    ($scope, $location, $routeParams, $interval, $timeout, ngDialog, KnowDocService,TemplateService,TipService,$state) =>{
        $scope.vm = {
