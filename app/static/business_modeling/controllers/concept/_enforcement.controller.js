...
module.exports = applicationManagementModule =>{
    ...
    //概念单条新增
        function singleAdd(){
            ...
            BusinessModelingServer.forceConceptAdd.save({
                "topic":  $scope.vm.key,
    ...
    function singleEditSynonymConcept(item){
        ...
        BusinessModelingServer.forceConceptUpdate.save({
            "id":item.id,
            "topic":  $scope.vm.key,
           // "weight":  $scope.vm.weight,
            "termList": $scope.vm.term,
        ...
        function addConcept(){
            ...
            var dialog = ngDialog.openConfirm({
                template:"/static/business_modeling/views/concept/enforcement/enforcement_dialog.html",
                scope: $scope,
                ...
                preCloseCallback:(e)=>{    //关闭回掉
                    if(e === 1){
                        ...
                        BusinessModelingServer.forceConceptRepeat.get({
                            "value":$scope.vm.key
                        },(data)=>{
                            //类名重複
        ...
        function addSynonymConceptDialog(callback,item){
            var dialog = ngDialog.openConfirm({
                template:"/static/business_modeling/views/concept/enforcement/enforcement_dialog2.html",
                scope: $scope,
                closeByDocument:false,
                closeByEscape: true,
                showClose : true,
        ...
        function deleteSingle(id){
            var dialog = ngDialog.openConfirm({
                ...
                preCloseCallback:function(e){    //关闭回掉
                    if(e === 1){
                    httpRequestPost("/api/ms/concept/forceSegment/delete/"+id+"",{
                    },function(data){
                        if(data.status==200){
