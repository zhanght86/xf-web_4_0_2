    ...
    '$scope', 'localStorageService' ,"$state" ,"ngDialog","$timeout","$cookieStore",function ($scope,localStorageService, $state,ngDialog,$timeout,$cookieStore) {
        ...
        function addCorrection(){
            var dialog = ngDialog.openConfirm({
                template: "/static/business_modeling/concept_library/error_correction/error_correction_manage_dialog.html",
                scope: $scope,
        ...
        function addCorrectionConceptDialog(callback,item){
            var dialog = ngDialog.openConfirm({
                template: "/static/business_modeling/concept_library/error_correction/error_correction_manage_dialog2.html",
                scope: $scope,
                closeByDocument: false,
                closeByEscape: true,
                showClose: true,
