...
'$scope', 'localStorageService' ,"$state" ,"ngDialog","$timeout","$cookieStore",function ($scope,localStorageService, $state,ngDialog,$timeout,$cookieStore) {
        ...
        function addSentiment(){
            var dialog = ngDialog.openConfirm({
                template: "/static/business_modeling/concept_library/sentiment/sentiment_concept_manage_dialog.html",
                scope: $scope,
        ...
        function addSentimentConceptDialog(callback,item){
            var dialog = ngDialog.openConfirm({
                template: "/static/business_modeling/concept_library/sentiment/sentiment_concept_manage_dialog2.html",
                scope: $scope,
                closeByDocument: false,
                closeByEscape: true,
                showClose: true,
