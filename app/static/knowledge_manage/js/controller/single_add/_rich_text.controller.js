        ...
        function addNewOrEditKnow(index){
            if(isNewKnowledgeTitle()){
               var parameter = {
                   ...
                   "dimensionIdList": $scope.vm.dimensionArr.length ? $scope.vm.dimensionArr : $scope.$parent.$parent.MASTER.dimensionListIds,
