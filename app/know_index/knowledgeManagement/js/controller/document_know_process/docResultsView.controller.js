    ...
    function ($scope,DetailService,localStorageService,$state,$stateParams,$timeout,ngDialog,$cookieStore) {
        ...
        function knowIgnoreAllConfirm(){
            var dialog = ngDialog.openConfirm({
                template:"/know_index/knowledgeManagement/document_know_process/doc_results_viewDialog.html",
                scope: $scope,
        ...
        function knowIgnoreConfirm(knowledgeId){
            var dialog = ngDialog.openConfirm({
                template:"/know_index/knowledgeManagement/document_know_process/doc_results_viewDialog2.html",
                scope: $scope,
                closeByDocument:false,
                closeByEscape: true,
                showClose : true,
        ...
        function addKnowClass(knowledgeId, knowledgeTitle, knowledgeContent){
            if($cookieStore.get("sceneId") == 2){ //营销场景直接跳转到营销知识新增
                ...
                var dialog = ngDialog.openConfirm({
                    template:"/know_index/knowledgeManagement/document_know_process/doc_results_viewDialog_add.html",
                    scope: $scope,
                    closeByDocument:false,
                    closeByEscape: true,
                    showClose : true,
