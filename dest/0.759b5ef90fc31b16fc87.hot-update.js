	    ...
	    //--------------------------------------------------
	    {
	        ...
	        templateProvider: ["$q", function ($q) {
	            ...
	            !/* require.ensure */(function () {
	                var template = __webpack_require__(!(function webpackMissingModule() { var e = new Error("Cannot find module \"../static/application_management/main.html\""); e.code = 'MODULE_NOT_FOUND'; throw e; }()));
	                deferred.resolve(template);
	            }(__webpack_require__));
	            return deferred.promise;
	        }],
