	...
	module.exports = function (angular) {
	    ...
	    //--------------------------------------------------
	    {
	        ...
	        templateProvider: ['$q', function ($q) {
	            var path = loginPath + 'loginPath/views/login.html';
	            var deferred = $q.defer();
	            __webpack_require__(17).ensure([path], function () {
	                var template = __webpack_require__(17)(path);
	        ...
	        resolve: {
	            loadDep: ['$q', '$ocLazyLoad', function ($q, $ocLazyLoad) {
	                var path = loginPath + '/module/loginModule.js';
	                var defer = $q.defer();
	                __webpack_require__(17).ensure([path], function () {
	                    var loginModule = __webpack_require__(17)(path)(angular); //动态加载Module
	                    $ocLazyLoad.load({
