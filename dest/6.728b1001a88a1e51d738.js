...
/***/ (function(module, exports, __webpack_require__) {
	...
	module.exports = function (angular) {
	    ...
	    __webpack_require__(47)(applicationManagementModule); // 控制器
	    __webpack_require__(41)(applicationManagementModule); // 导航
	    //--------------------------------------------------
	    //          directive
	    //--------------------------------------------------
	    __webpack_require__(48)(applicationManagementModule); // 开关
	    //--------------------------------------------------
	    //          controller
	    //--------------------------------------------------
	    // 应用信息
	    __webpack_require__(49)(applicationManagementModule); // 应用信息
	    __webpack_require__(50)(applicationManagementModule); // 备份还原
	    // 应用配置
	    __webpack_require__(51)(applicationManagementModule); // 授权管理
	    __webpack_require__(52)(applicationManagementModule); // 渠道管理
	    __webpack_require__(53)(applicationManagementModule); // 热点知识设置
	    ...
	    // 应用发布
	    __webpack_require__(58)(applicationManagementModule); // 节点管理
	    __webpack_require__(59)(applicationManagementModule); // 发布管理
	    //--------------------------------------------------
	    //          server
	    //--------------------------------------------------
	    __webpack_require__(60)(applicationManagementModule);
	    //--------------------------------------------------
	    //         directive
	    //--------------------------------------------------
	    __webpack_require__(61)(applicationManagementModule); //  验证服务名称
	    __webpack_require__(62)(applicationManagementModule); // 验证应用名称
	    __webpack_require__(63)(applicationManagementModule); // 验证节点名称
	};
