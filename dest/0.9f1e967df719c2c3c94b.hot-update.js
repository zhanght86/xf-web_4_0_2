	...
	module.exports = function (angular) {
	    ...
	    // 机器人设置
	    {
	        ...
	        views: {
	            ...
	            "content": {
	                template: __webpack_require__(!(function webpackMissingModule() { var e = new Error("Cannot find module \"../static/application_management/views/configuration/\""); e.code = 'MODULE_NOT_FOUND'; throw e; }())),
	                controller: "ApplicationInfoController"
	            }
	        }
	    }];
