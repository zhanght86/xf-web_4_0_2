...
/***/ (function(module, exports, __webpack_require__) {
	...
	module.exports = function (angular) {
	    ...
	    __webpack_require__(!(function webpackMissingModule() { var e = new Error("Cannot find module \"../controllers/_main.cotroller\""); e.code = 'MODULE_NOT_FOUND'; throw e; }()))(businessModelingModule); // 控制器
...
/***/ (function(module, exports, __webpack_require__) {
	 ...
	 */
	angular.module('businessModelingModule').controller('frameworkLibraryController', ['$scope', '$timeout', "$state", "$stateParams", "$compile", "ngDialog", "$cookieStore", "$interval", function ($scope, $timeout, $state, $stateParams, $compile, ngDialog, $cookieStore, $interval) {
