...
/***/ (function(module, exports) {
	 ...
	 */
	angular.module('myApplicationSettingModule').controller('applicationInforController', ['$scope', 'localStorageService', "ApplicationServer", "$state", "ngDialog", "$cookieStore", "$rootScope", "$timeout", "$log", function ($scope, localStorageService, ApplicationServer, $state, ngDialog, $cookieStore, $rootScope, $timeout, $log) {
	    $scope.vm = {
...
/***/ (function(module, exports) {
	 ...
	 * Date: 2017/4/10 17:16
	 */
	angular.module('myApplicationSettingModule').controller('backupRestoreController', ['$scope', 'localStorageService', "ApplicationServer", "$state", "ngDialog", "$cookieStore", "$rootScope", "$timeout", "$log", function ($scope, localStorageService, ApplicationServer, $state, ngDialog, $cookieStore, $rootScope, $timeout, $log) {
	    $scope.vm = {};
	}]);
...
/***/ (function(module, exports) {
	...
	angular.module('myApplicationSettingModule').controller('channelManageController', ['$scope', 'localStorageService', "ApplicationServer", "$state", "ngDialog", "$cookieStore", "$timeout", function ($scope, localStorageService, ApplicationServer, $state, ngDialog, $cookieStore, $timeout) {
	    //渠道管理
	    $scope.vm = {
	        channelData: "", // 渠道数据
	        paginationConf: "", //分页条件
...
/***/ (function(module, exports, __webpack_require__) {
	 ...
	 * Describe ： 热点知识设置
	 */
	angular.module('knowledgeManagementModule').controller('hotKnowledgeSetupController', ['$scope', 'localStorageService', "ApplicationServer", "$state", "ngDialog", "$cookieStore", "$timeout", function ($scope, localStorageService, ApplicationServer, $state, ngDialog, $cookieStore, $timeout) {
	    $scope.vm = {
	        //热点知识
	        hotKnowList: "", // 热点知识 数据
...
/***/ (function(module, exports, __webpack_require__) {
	 ...
	 * @Module :  转人工
	 */
	angular.module('myApplicationSettingModule').controller('manualSettingController', ['$scope', 'localStorageService', "ApplicationServer", "$state", "ngDialog", '$http', "$cookieStore", "$rootScope", function ($scope, localStorageService, ApplicationServer, $state, ngDialog, $http, $cookieStore, $rootScope) {
	    $scope.vm = {
	        id: '', //返回的id
	        workStartTime: '', //开始时间
	        workEndTime: '', //结束时间
...
/***/ (function(module, exports) {
	 ...
	 * @Module :  参数设置 控制器
	 */
	angular.module("myApplicationSettingModule").controller("parameterSetupController", ['$scope', 'localStorageService', "ApplicationServer", "$state", "ngDialog", '$http', "$cookieStore", function ($scope, localStorageService, ApplicationServer, $state, ngDialog, $http, $cookieStore) {
	    $scope.vm = {
...
/***/ (function(module, exports, __webpack_require__) {
	...
	angular.module('myApplicationSettingModule').controller('robotSetupController', ['$scope', 'localStorageService', "ApplicationServer", "$state", "ngDialog", '$http', "$cookieStore", "$rootScope", function ($scope, localStorageService, ApplicationServer, $state, ngDialog, $http, $cookieStore, $rootScope) {
	    $scope.vm = {
...
/***/ (function(module, exports) {
	 ...
	 * Date: 2017/4/5 15:39
	 */
	angular.module('myApplicationSettingModule').controller('sceneManageController', ['$scope', 'localStorageService', "ApplicationServer", "$state", "ngDialog", "$cookieStore", function ($scope, localStorageService, ApplicationServer, $state, ngDialog, $cookieStore) {
	    $scope.vm = {
...
/***/ (function(module, exports) {
	 ...
	 * Date: 2017/4/10 9:59
	 */
	angular.module('myApplicationSettingModule').controller('releaseManageController', ['$scope', 'localStorageService', "ApplicationServer", "$state", "ngDialog", "$cookieStore", "$timeout", "$interval", function ($scope, localStorageService, ApplicationServer, $state, ngDialog, $cookieStore, $timeout, $interval) {
	    $scope.vm = {
	        serviceList: "", // 服务列表数据
	        paginationConf: { // 分页条件
	            pageSize: 5,
