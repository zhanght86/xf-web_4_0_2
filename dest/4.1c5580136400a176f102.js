...
/***/ (function(module, exports, __webpack_require__) {
	...
	module.exports = function (angular) {
	  var homePageModule = angular.module('homePageModule', ['know']);
	  __webpack_require__(27)(homePageModule); // 导航
	  __webpack_require__(28)(homePageModule); // 主体
	};
...
/***/ (function(module, exports) {
	 ...
	 */
	angular.module('homePage').controller('homePageNavController', ['$scope', '$location', 'localStorageService', 'ngDialog', 'AuthService', "$timeout", "$cookieStore", "$state", function ($scope, $location, localStorageService, ngDialog, AuthService, $timeout, $cookieStore, $state) {
...
/***/ (function(module, exports) {
	 ...
	 */
	//首页controller
	angular.module('homePage').controller('homePageContentController', ['$scope', '$location', 'localStorageService', "$state", "$cookieStore", function ($scope, $location, localStorageService, $state, $cookieStore) {
	    $scope.vm = {
	        sceneId: SCENE_ID
	    };
	}]);
