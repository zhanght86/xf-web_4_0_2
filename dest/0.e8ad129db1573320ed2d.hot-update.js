...
/***/ (function(module, exports, __webpack_require__) {
	...
	module.exports = function (angular) {
	    ...
	    //--------------------------------------------------
	    {
	        ...
	        title: "知识总览",
	        template: __webpack_require__(!(function webpackMissingModule() { var e = new Error("Cannot find module \"../static/knowledge_management/views/main.html\""); e.code = 'MODULE_NOT_FOUND'; throw e; }())),
	        resolve: {
	            loadDep: ["$q", "$ocLazyLoad", function ($q, $ocLazyLoad) {
	                var defer = $q.defer();
	                __webpack_require__.e/* nsure */(13, function () {
	                    var KnowledgeManagementModule = __webpack_require__(70)(angular); //动态加载Module
	                    $ocLazyLoad.load({
	                        name: "KnowledgeManagementModule" //name就是你module的名称
	                    });
