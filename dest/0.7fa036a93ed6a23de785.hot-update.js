	    ...
	    //--------------------------------------------------
	    {
	        ...
	        templateProvider: ['$q', function ($q) {
	            ...
	            !/* require.ensure */(function () {
	                var template = __webpack_require__(!(function webpackMissingModule() { var e = new Error("Cannot find module \"loginPath/views/login.html\""); e.code = 'MODULE_NOT_FOUND'; throw e; }()));
	        ...
	        resolve: {
	            loadDep: ['$q', '$ocLazyLoad', function ($q, $ocLazyLoad) {
	                var defer = $q.defer();
	                !/* require.ensure */(function () {
	                    var loginModule = __webpack_require__(!(function webpackMissingModule() { var e = new Error("Cannot find module \"loginPath/module/loginModule.js\""); e.code = 'MODULE_NOT_FOUND'; throw e; }()))(angular); //动态加载Module
	                    $ocLazyLoad.load({
