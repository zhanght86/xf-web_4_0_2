...
/***/ (function(module, exports, __webpack_require__) {
	...
	module.exports = function (angular) {
	    ...
	    __webpack_require__(89)(businessModelingModule); // 控制器
	    __webpack_require__(65)(businessModelingModule); // 导航
	    //--------------------------------------------------
	    //          directive
	    //--------------------------------------------------
	    __webpack_require__(72)(businessModelingModule); // 开关
	    //--------------------------------------------------
	    //          controller
	    //--------------------------------------------------
	    // BOT
	    __webpack_require__(90)(businessModelingModule); // bot
	    __webpack_require__(91)(businessModelingModule); // bot套用

	    // 框架库
	    __webpack_require__(92)(businessModelingModule); // 同义
	    __webpack_require__(93)(businessModelingModule); // 集合
	    __webpack_require__(94)(businessModelingModule); // 业务
	    __webpack_require__(95)(businessModelingModule); // 敏感
	    __webpack_require__(96)(businessModelingModule); // 停用
	    __webpack_require__(97)(businessModelingModule); // 强制分词
	    __webpack_require__(94)(businessModelingModule); // bot

	    // 概念库
	    __webpack_require__(98)(businessModelingModule); // 节点管理

	    //--------------------------------------------------
	    //          server
	    //--------------------------------------------------
	    __webpack_require__(99)(businessModelingModule);
	    //--------------------------------------------------
	    //         directive
	    //--------------------------------------------------
	};
...
/***/ (function(module, exports, __webpack_require__) {
	 ...
	 */
	module.exports = function (applicationManagementModule) {
	    applicationManagementModule.controller('AggregateConceptController', ['$scope', 'localStorageService', "$state", "ngDialog", "$timeout", function ($scope, localStorageService, $state, ngDialog, $timeout) {
	        $scope.vm = {
	            success: 10000,
	            illegal: 10003,
	            failed: 10004,
...
/***/ (function(module, exports, __webpack_require__) {
	 ...
	 */
	module.exports = function (applicationManagementModule) {
	    applicationManagementModule.controller('SensitiveConceptController', ['$scope', 'localStorageService', "$state", "ngDialog", "$timeout", function ($scope, localStorageService, $state, ngDialog, $timeout) {
	        $scope.vm = {
	            success: 10000,
	            illegal: 10003,
	            failed: 10004,
...
/***/ (function(module, exports, __webpack_require__) {
	 ...
	 */
	module.exports = function (applicationManagementModule) {
	    applicationManagementModule.controller('DisableConceptController', ['$scope', 'localStorageService', "$state", "ngDialog", "$timeout", function ($scope, localStorageService, $state, ngDialog, $timeout) {
	        $scope.vm = {
	            success: 10000,
	            illegal: 10003,
	            failed: 10004,
