...
/***/ (function(module, exports, __webpack_require__) {
	 ...
	 */
	module.exports = function (knowledgeManagementModule) {
	    knowledgeManagementModule.controller('FaqEditController', ['$scope', 'localStorageService', "KnowledgeService", "$state", "ngDialog", "$cookieStore", "$timeout", "$compile", "$stateParams", "knowledgeAddServer", "$window", "$rootScope", "$filter", function ($scope, localStorageService, KnowledgeService, $state, ngDialog, $cookieStore, $timeout, $compile, $stateParams, knowledgeAddServer, $window, $rootScope, $filter) {
