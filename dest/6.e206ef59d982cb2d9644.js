...
/***/ (function(module, exports, __webpack_require__) {
	...
	module.exports = function (angular) {
	    ...
	    __webpack_require__(71)(applicationManagementModule); // 控制器
	    __webpack_require__(65)(applicationManagementModule); // 导航
	    //--------------------------------------------------
	    //          directive
	    //--------------------------------------------------
	    __webpack_require__(72)(applicationManagementModule); // 开关
	    //--------------------------------------------------
	    //          controller
	    //--------------------------------------------------
	    // 应用信息
	    __webpack_require__(73)(applicationManagementModule); // 应用信息
	    __webpack_require__(74)(applicationManagementModule); // 备份还原
	    // 应用配置
	    __webpack_require__(75)(applicationManagementModule); // 授权管理
	    __webpack_require__(76)(applicationManagementModule); // 渠道管理
	    __webpack_require__(77)(applicationManagementModule); // 热点知识设置
	    __webpack_require__(78)(applicationManagementModule); // 授权管理
	    __webpack_require__(79)(applicationManagementModule); // 授权管理
	    __webpack_require__(80)(applicationManagementModule); // 授权管理
	    __webpack_require__(81)(applicationManagementModule); // 授权管理
	    // 应用发布
	    __webpack_require__(82)(applicationManagementModule); // 节点管理
	    __webpack_require__(83)(applicationManagementModule); // 发布管理
	    //--------------------------------------------------
	    //          server
	    //--------------------------------------------------
	    __webpack_require__(84)(applicationManagementModule);
	    //--------------------------------------------------
	    //         directive
	    //--------------------------------------------------
	    __webpack_require__(85)(applicationManagementModule); //  验证服务名称
	    __webpack_require__(86)(applicationManagementModule); // 验证应用名称
	    __webpack_require__(87)(applicationManagementModule); // 验证节点名称
	};
