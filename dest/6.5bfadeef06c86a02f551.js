...
/***/ (function(module, exports, __webpack_require__) {
	...
	module.exports = function (angular) {
	    ...
	    __webpack_require__(46)(applicationManagementModule); // 导航
	    __webpack_require__(47)(applicationManagementModule); // 导航
	    //--------------------------------------------------
	    //          controller
	    //--------------------------------------------------
	    // 应用信息
	    __webpack_require__(48)(applicationManagementModule); // 应用信息
	    __webpack_require__(49)(applicationManagementModule); // 备份还原
	    // 应用配置
	    __webpack_require__(50)(applicationManagementModule); // 授权管理
	    __webpack_require__(51)(applicationManagementModule); // 渠道管理
	    __webpack_require__(52)(applicationManagementModule); // 热点知识设置
	    __webpack_require__(53)(applicationManagementModule); // 授权管理
	    __webpack_require__(54)(applicationManagementModule); // 授权管理
	    __webpack_require__(55)(applicationManagementModule); // 授权管理
	    __webpack_require__(56)(applicationManagementModule); // 授权管理
	    // 应用发布
	    __webpack_require__(57)(applicationManagementModule); // 节点管理
	    __webpack_require__(58)(applicationManagementModule); // 发布管理
	    //--------------------------------------------------
	    //          server
	    //--------------------------------------------------
	    __webpack_require__(59)(applicationManagementModule);
	    //--------------------------------------------------
	    //         directive
	    //--------------------------------------------------
	    __webpack_require__(60)(applicationManagementModule); //  验证服务名称
	    __webpack_require__(61)(applicationManagementModule); // 验证应用名称
	    __webpack_require__(62)(applicationManagementModule); // 验证节点名称
	};
...
/***/ (function(module, exports, __webpack_require__) {
	...
	angular.module('myApplicationSettingModule').controller('ApplicationSettingController', ['$scope', "$state", "$stateParams", "$cookieStore", "$rootScope", function ($scope, $state, $stateParams, $cookieStore, $rootScope) {
