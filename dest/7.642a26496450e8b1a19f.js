...
/***/ (function(module, exports, __webpack_require__) {
	...
	module.exports = function (angular) {
	    ...
	    __webpack_require__(79)(businessModelingModule); // 控制器
	    __webpack_require__(55)(businessModelingModule); // 导航
	    //--------------------------------------------------
	    //          directive
	    //--------------------------------------------------
	    __webpack_require__(62)(businessModelingModule); // 开关
	    //--------------------------------------------------
	    //          controller
	    //--------------------------------------------------
	    // BOT
	    __webpack_require__(80)(businessModelingModule); // bot
	    __webpack_require__(81)(businessModelingModule); // bot套用

	    // 框架库
	    __webpack_require__(82)(businessModelingModule); // 同义
	    __webpack_require__(83)(businessModelingModule); // 集合
	    __webpack_require__(84)(businessModelingModule); // 业务
	    __webpack_require__(85)(businessModelingModule); // 敏感
	    __webpack_require__(86)(businessModelingModule); // 停用
	    __webpack_require__(87)(businessModelingModule); // 强制分词
	    __webpack_require__(84)(businessModelingModule); // bot

	    // 概念库
	    __webpack_require__(88)(businessModelingModule); // 节点管理

	    //--------------------------------------------------
	    //          server
	    //--------------------------------------------------
	    __webpack_require__(89)(businessModelingModule);
	    //--------------------------------------------------
	    //         directive
	    //--------------------------------------------------
	};
