...
/***/ (function(module, exports) {
	...
	module.exports = function (homePageModule) {
	    homePageModule.controller('homePageNavController', ['$scope', '$location', 'localStorageService', 'ngDialog', 'AuthService', "$timeout", "$cookieStore", "$state", function ($scope, $location, localStorageService, ngDialog, AuthService, $timeout, $cookieStore, $state) {
