...
/***/ (function(module, exports, __webpack_require__) {
	...
	module.exports = function (angular) {
	    ...
	    // 应用发布
	    __webpack_require__(47)(applicationManagementModule); // 节点管理
	    __webpack_require__(48)(applicationManagementModule); // 发布管理
	    //--------------------------------------------------
	    //          server
	    //--------------------------------------------------
	    __webpack_require__(49)(applicationManagementModule);
	    //--------------------------------------------------
	    //         directive
	    //--------------------------------------------------
	    __webpack_require__(50)(applicationManagementModule); //  验证服务名称
	    __webpack_require__(51)(applicationManagementModule); // 验证应用名称
	    __webpack_require__(52)(applicationManagementModule); // 验证节点名称
	};
