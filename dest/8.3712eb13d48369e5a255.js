webpackJsonp([8],Array(54).concat([
/* 54 */
...
/***/ (function(module, exports, __webpack_require__) {
	...
	module.exports = function (angular) {
	    ...
	    __webpack_require__(90)(knowledgeManagementModule); // 控制器
	    __webpack_require__(54)(knowledgeManagementModule); // 导航

	    //--------------------------------------------------
	    //         server
	    //--------------------------------------------------
	    __webpack_require__(91)(knowledgeManagementModule); // 服务
	    __webpack_require__(92)(knowledgeManagementModule); // 服务
	    //--------------------------------------------------
	    //         controller
	    //--------------------------------------------------
	    // ------    知识总览 -------//
	    __webpack_require__(93)(knowledgeManagementModule); // 总览
	    __webpack_require__(94)(knowledgeManagementModule); // 查看
	    __webpack_require__(95)(knowledgeManagementModule); // 预览
	    // ------    单条新增 编辑 -------//
	    __webpack_require__(96)(knowledgeManagementModule); // 概念新增
	    __webpack_require__(97)(knowledgeManagementModule); // 概念编辑
	    __webpack_require__(98)(knowledgeManagementModule); // faq新增
	    __webpack_require__(99)(knowledgeManagementModule); // faq编辑
	    __webpack_require__(100)(knowledgeManagementModule); // 列表新增
	    __webpack_require__(101)(knowledgeManagementModule); // 列表编辑
	    __webpack_require__(102)(knowledgeManagementModule); // 要素新增
	    __webpack_require__(103)(knowledgeManagementModule); // 要素编辑
	    __webpack_require__(104)(knowledgeManagementModule); // 富文本新增
	    __webpack_require__(105)(knowledgeManagementModule); // 富文本编辑
	    __webpack_require__(106)(knowledgeManagementModule); // 对话新增
	    __webpack_require__(107)(knowledgeManagementModule); // 对话编辑
	    // ------    知识批量新增  -------//
	    __webpack_require__(108)(knowledgeManagementModule); // 批量新增
	    // ------    文档加工  ----------//
	    __webpack_require__(109)(knowledgeManagementModule); //
	    ...
	    // ------    历史查看  ----------//
	    __webpack_require__(115)(knowledgeManagementModule); // 历史查看
	    //--------------------------------------------------
	    //         directive
	    //--------------------------------------------------
