...
/***/ (function(module, exports, __webpack_require__) {
	...
	module.exports = function (angular) {
	    ...
	    //--------------------------------------------------
	    // ------    知识总览 -------//
	    __webpack_require__(71)(knowledgeManagementModule); // 总览
	    __webpack_require__(72)(knowledgeManagementModule); // 查看
	    __webpack_require__(73)(knowledgeManagementModule); // 预览
	    // ------    单条新增 编辑 -------//
	    __webpack_require__(74)(knowledgeManagementModule); // 概念新增
	    __webpack_require__(75)(knowledgeManagementModule); // 概念编辑
	    __webpack_require__(76)(knowledgeManagementModule); // faq新增
	    __webpack_require__(77)(knowledgeManagementModule); // faq编辑
	    __webpack_require__(78)(knowledgeManagementModule); // 列表新增
	    __webpack_require__(79)(knowledgeManagementModule); // 列表编辑
	    __webpack_require__(80)(knowledgeManagementModule); // 要素新增
	    __webpack_require__(81)(knowledgeManagementModule); // 要素编辑
	    __webpack_require__(82)(knowledgeManagementModule); // 富文本新增
	    __webpack_require__(83)(knowledgeManagementModule); // 富文本编辑
	    // ------    知识批量新增  -------//
	    __webpack_require__(84)(knowledgeManagementModule); // 批量新增
	    // ------    文档加工  ----------//
	    ...
	    // ------    历史查看  ----------//
	    __webpack_require__(91)(knowledgeManagementModule); // 历史查看
	    //--------------------------------------------------
	    //         directive
	    //--------------------------------------------------
