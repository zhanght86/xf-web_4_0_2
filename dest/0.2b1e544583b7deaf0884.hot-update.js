	        ...
	        resolve: {
	            loadDep: ["$q", "$ocLazyLoad", function ($q, $ocLazyLoad) {
	                ...
	                __webpack_require__.e/* nsure */(3, function () {
	                    var loginModule = __webpack_require__(49)(angular); //动态加载Module
	                    $ocLazyLoad.load({
	        ...
	        resolve: {
	            loadDep: ["$q", "$ocLazyLoad", function ($q, $ocLazyLoad) {
	                ...
	                __webpack_require__.e/* nsure */(4, function () {
	                    var homePageModule = __webpack_require__(52)(angular); //动态加载Module
	                    $ocLazyLoad.load({
	        ...
	        resolve: {
	            loadDep: ["$q", "$ocLazyLoad", function ($q, $ocLazyLoad) {
	                ...
	                __webpack_require__.e/* nsure */(6, function () {
	                    var applicationManagementModule = __webpack_require__(58)(angular);
	                    $ocLazyLoad.load({
	        ...
	        resolve: {
	            loadDep: ["$q", "$ocLazyLoad", function ($q, $ocLazyLoad) {
	                ...
	                __webpack_require__.e/* nsure */(9, function () {
	                    var businessModelingModule = __webpack_require__(113)(angular);
	                    $ocLazyLoad.load({
	        ...
	        resolve: {
	            loadDep: ["$q", "$ocLazyLoad", function ($q, $ocLazyLoad) {
	                ...
	                __webpack_require__.e/* nsure */(7, function () {
	                    var knowledgeManagementModule = __webpack_require__(76)(angular);
	                    $ocLazyLoad.load({
