...
/***/ (function(module, exports, __webpack_require__) {
	...
	module.exports = function (angular) {
	    ...
	    __webpack_require__(60)(applicationManagementModule); // 控制器
	    __webpack_require__(54)(applicationManagementModule); // 导航
	    //--------------------------------------------------
	    //          directive
	    //--------------------------------------------------
	    __webpack_require__(61)(applicationManagementModule); // 开关
	    //--------------------------------------------------
	    //          controller
	    //--------------------------------------------------
	    // 应用信息
	    __webpack_require__(62)(applicationManagementModule); // 应用信息
	    __webpack_require__(63)(applicationManagementModule); // 备份还原
	    // 应用配置
	    __webpack_require__(64)(applicationManagementModule); // 授权管理
	    __webpack_require__(65)(applicationManagementModule); // 渠道管理
	    __webpack_require__(66)(applicationManagementModule); // 热点知识设置
	    ...
	    // 应用发布
	    __webpack_require__(71)(applicationManagementModule); // 节点管理
	    __webpack_require__(72)(applicationManagementModule); // 发布管理
	    //--------------------------------------------------
	    //          server
	    //--------------------------------------------------
	    ...
	    //         directive
	    //--------------------------------------------------
	    __webpack_require__(74)(applicationManagementModule); //  验证服务名称
	    __webpack_require__(75)(applicationManagementModule); // 验证应用名称
	    __webpack_require__(76)(applicationManagementModule); // 验证节点名称
	};
